...
Array.from(document.getElementsByClassName('songItem')).forEach((element, i)=>{     //get all elements having class of song item
...
masterPlay.addEventListener('click',()=>{                                   //executes on mouseclick
...
right_scrolls.addEventListener('click', ()=>{
    item.scrollLeft += 330;                               //add 330px on scrolling
})
